...
void setup() {
  ...
  while (soap.getServerInfo(i, &serv)) {
    ...
    // send search request to media server: title must contain the string "you"
    if (!soap.searchServer(i, "0", &searchResult, SOAP_SEARCH_CRITERIA_TITLE, "you")) {
